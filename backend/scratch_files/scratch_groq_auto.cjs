...
async function testGroq() {
    ...
    const structureContext = `\n    - NARRATIVE ARC: Organize the slides logically according to a "Problem-Solution" structure.`;
    ...
    - CRITICAL: DO NOT just return the name of the structure. You MUST generate the FULL array of slides.
    ...
    try {
        const response = await groq.chat.completions.create({
            ...
            messages: [
                ...
                { role: "user", content: `Outline a professionally structured presentation about: testing` }
            ],
